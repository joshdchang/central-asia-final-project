  ...
  <div>
    <div class="modal modal-open font-serif z-[1001]">
      <div class="modal-box w-11/12 max-w-4xl p-24">
        ...
        <p class="py-4 text-2xl">
          Although plov is “ubiquitous” [2] across various places, what makes Central Asian plov unique, and specifically Uzbek plov unique, is the
          ...
          you eat a handful from the platter” [3]. This expression bluntly describes how much Uzbeks value oil in their plov, an assessment I
        ...
        <p class="py-4 text-2xl">
          ...
          northern foothills of the Central Asian mountains” [6]. Here, Spengler claims that wheat, barley, and millet — all cereal grains — were some
        ...
        <p class="py-4 text-2xl">
          ...
          already in place” [7], Spengler writes, demonstrating that the wet and fertile foothills were essential to spreading grains throughout
        ...
        <p class="py-4 text-2xl">
          ...
          and diets [9]. Although grain is consumed all over the world, Central Asia’s especially substantial reliance on cereal grains is a result of
